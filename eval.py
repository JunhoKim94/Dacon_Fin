...
def main():
    ...
    x_train, y_train, x_val, y_val = data_gen(data_path = train_path, stop_words = stopwords, tokenizer = Kkma(), size = size)
    ...
    model = RNNLM(vocab_size = len(corpus), hidden_layer = hidden_layer, max_len = max_len)
